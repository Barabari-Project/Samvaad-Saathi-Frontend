                        ...
                        return (
                            <div key={index} className={cardClasses}>
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className={`text-sm capitalize ${statusTextColor}`}>
                                        {section.status}
                                    </p>
                                </div>
                ...
                <div className="space-y-0">
                    {timePerSection.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                <span
                                    className={`text-sm ${isIncomplete ? "text-orange-600" : "text-gray-700"
                                        }`}
                                >
                                    {item.sectionName}
                                </span>
                                <span
                                    className={`text-sm font-medium ${isIncomplete ? "text-orange-600" : "text-gray-700"
                                        }`}
                                >
