    ...
    return (
      ...
      /> */}
            ...
            >
                <a
                    role="tab"
                    className={`tab flex-1 ${activeTab === "per-question"
                ...
                <a
                    role="tab"
                    className={`tab flex-1 ${activeTab === "final-summary"
                        ? "tab-active shadow-2xl rounded-xl"
                        : ""
                        }`}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="card bg-base-100 rounded-xl shadow-md">
                        <div className="card-body gap-4 p-6">
                            ...
                            <div className="flex justify-end">
                                <Link href={`/pronunciation-practice?role=${reportData.candidateInfo.roleTopic}&difficulty=medium`}>
                                    <button className="btn btn-primary cursor-pointer">
                                        Practice Now
                                        <ArrowRightIcon className="w-5 h-5" />
                                    </button>
